...
/**
 * The following class comprises all the calculation logic
 */
public class Kernel {

    // contains numbers as Strings. Can contain "-33.55555"
    private final MyStack<String> nums = new MyStack<>();
    // contains operators like ^ * / + - (
    private final MyStack<String> operators = new MyStack<>();
