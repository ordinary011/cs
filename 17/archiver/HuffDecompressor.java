...
import com.shpp.p2p.cs.ldebryniuk.assignment17.archiver.binaryTree.BTreeNode;
import com.shpp.p2p.cs.ldebryniuk.assignment17.archiver.binaryTree.InternalTreeNode;
...
public class HuffDecompressor extends CommonUtils {
     ...
     */
    private MyArrayList<Integer> createArrOfEncodingLengths(int tableInfoSize) {
        MyArrayList<Integer> lengthsOfEncodings = new MyArrayList<>();
    ...
    private InternalTreeNode recreateTree(int tableInfoSize) {
        MyArrayList<Integer> lengthsOfEncodings = createArrOfEncodingLengths(tableInfoSize);
